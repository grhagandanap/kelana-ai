    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="px-4 py-12 sm:px-6 md:px-8 lg:px-12 pt-24">
        <div className="mx-auto max-w-4xl">
          {!checkedAuth ? (
            // Avoid a flash of the wrong section while we check localStorage
              ...
              <div className="relative">
                ...
                <form className="space-y-8" onSubmit={handleSubmit}>
                  <div className="space-y-3">
                    <label htmlFor="destination" className="text-base font-medium text-slate-200">
                  ...
                  <div className="grid gap-8 sm:grid-cols-2">
                    <div className="space-y-3">
                      <label htmlFor="days" className="text-base font-medium text-slate-200">
                        How many days?
                      </label>
                      <input
                        id="days"
                    ...
                    <div className="space-y-3">
                      <label htmlFor="budget" className="text-base font-medium text-slate-200">
                        What's your budget?
                      </label>
                      <input
                        id="budget"
                  ...
                  <div className="space-y-3">
                    <label htmlFor="travelStyle" className="text-base font-medium text-slate-200">
            ...
            <section
              id="trip-form"
              className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-10 text-center shadow-2xl backdrop-blur-xl sm:p-14"
            >
              <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-cyan-400/10 blur-3xl" />
              <div className="absolute -left-20 -bottom-20 h-40 w-40 rounded-full bg-purple-400/10 blur-3xl" />
              ...
              <div className="relative">
                ...
                <p className="mx-auto mb-8 max-w-md text-slate-300">
                  Create a free account to generate AI-powered itineraries tailored to your destination, budget, and travel style.
                </p>

                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Link
                    href="/register"
                    className="w-full rounded-2xl bg-gradient-to-r from-cyan-400 via-cyan-500 to-blue-500 px-8 py-4 font-semibold text-slate-950 transition-all duration-300 hover:from-cyan-300 hover:via-cyan-400 hover:to-blue-400 hover:shadow-lg hover:shadow-cyan-400/25 sm:w-auto"
                  >
                    Sign Up Free
                  </Link>
                  <Link
                    href="/login"
                    className="w-full rounded-2xl border border-white/20 px-8 py-4 font-semibold text-white transition hover:border-cyan-400/50 sm:w-auto"
                  >
                    Log In
                  </Link>
                </div>
